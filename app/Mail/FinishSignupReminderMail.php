 ...
 * they never confirmed their email ('verify'), confirmed it but never chose a
 * membership ('choose'), or chose one but never paid ('pay'). Sent by the
 * stale-signup cleanup before the account is archived.
 */
class FinishSignupReminderMail extends Mailable
{
    ...
    /**
     * @param  string  $variant  'verify' (email never confirmed), 'choose' (no
     *                           membership chosen) or 'pay' (chosen, unpaid)
     */
