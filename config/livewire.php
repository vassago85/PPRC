...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        // Default MUST be local: if null, Livewire falls back to filesystems.default (often s3),
        // and the browser gets presigned PUTs to internal http://pprc-minio:9000 (mixed content).
        // Filament ->disk('s3') still stores the final file on S3 after upload completes.
