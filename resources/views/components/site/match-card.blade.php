        ...
        <div class="overflow-hidden rounded-t-2xl">
            @if ($banner)
                <div class="aspect-video w-full overflow-hidden">
                    <img src="{{ $banner }}" alt="{{ $title }}" class="h-full w-full object-cover" loading="lazy" />
                </div>
            @else
                <div class="aspect-video w-full overflow-hidden bg-slate-800/60 flex items-center justify-center">
                    <svg class="size-10 text-slate-600" fill="none" viewBox="0 0 24 24" stroke-width="1" stroke="currentColor">
