<div class="rounded-2xl border border-white/10 bg-gradient-to-br from-white/[0.07] to-white/[0.02] p-5 shadow-[0_20px_50px_-24px_rgba(0,0,0,0.65)] sm:p-6">
    ...
    @php
        // Members with a household still see the picker even when they are on
        // the list themselves — the whole point is that they can also enter
        // their juniors / spouse without switching accounts.
                ...
                @auth
                    ...
                    @else
                        ...
                        @if ($household->count() > 1)
                            ...
                            <ul class="mt-3 divide-y divide-white/5 rounded-xl border border-white/10 bg-slate-950/40" dusk="household-picker">
