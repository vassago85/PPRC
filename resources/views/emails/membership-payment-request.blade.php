                    ...
                    <tr>
                        <td style="background-color:#0f172a;background:linear-gradient(135deg,#0f172a 0%,#1e293b 50%,#0f172a 100%);padding:40px 36px 32px;text-align:center;">
                            ...
                            <p style="margin:0;font-size:11px;letter-spacing:0.18em;text-transform:uppercase;color:#d97706;font-weight:700;">
                                {{ $isReminder ? 'Payment reminder' : 'Payment required' }}
                            </p>
                    ...
                    <tr>
                        <td style="padding:32px 36px 0;">
                            ...
                            <p style="margin:0 0 16px;font-size:15px;color:#334155;line-height:1.65;">
                                @if ($isReminder)
                                    This is a reminder that your <strong>{{ e($typeName) }}</strong> membership at Pretoria Precision Rifle Club is still awaiting payment.
                                @else
                                    Your <strong>{{ e($typeName) }}</strong> membership at Pretoria Precision Rifle Club is ready — please pay the amount below to activate it.
                                @endif
                            </p>
                            <p style="margin:0 0 16px;font-size:15px;color:#334155;line-height:1.65;">
                                <strong>Already paid?</strong> Log in to the member portal and upload your proof of payment (PDF or image). The committee will verify it and activate your membership.
                            </p>
                        </td>
                    </tr>
                            ...
                            <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#fffbeb;border:1px solid #fde68a;border-radius:12px;overflow:hidden;">
                                ...
                                <tr>
                                    <td style="padding:0 20px 10px;text-align:center;">
                                        <p style="margin:0;font-family:Consolas,Monaco,monospace;font-size:32px;font-weight:700;color:#0f172a;letter-spacing:0.04em;line-height:1.2;">{{ $payment->reference }}</p>
                                        ...
                                        <p style="margin:4px 0 0;font-size:12px;color:#64748b;line-height:1.5;">
                                            ...
                                            This one is for your membership only &mdash; match entries each get their own reference.
                                        </p>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="padding:0 20px 18px;text-align:center;">
                                        ...
                                        <p style="margin:4px 0 0;font-size:28px;font-weight:700;color:#0f172a;">R {{ number_format($payment->amount_cents / 100, 2) }}</p>
                                    </td>
                                </tr>
                            </table>
                        </td>
